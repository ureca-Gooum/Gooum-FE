...
export const LoginPage = () => {
  ...
  return (
    <div className="flex-1 rounded-2xl bg-white p-4 shadow-md border border-gray-100 flex flex-col items-center justify-center relative overflow-y-auto sm:p-8">
      <div className="flex max-w-[600px] w-full flex-col items-center text-center mt-[-20px] sm:mt-[-40px]">
        ...
        <div className="mb-2 flex w-full max-w-[480px] items-center justify-center">
          <img src={illustrationImage} alt="Illustration" className="h-auto w-full object-contain" />
        </div>
